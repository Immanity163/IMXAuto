                ...
                <div className={cls.sheetInner}>
                    ...
                    <div className={cls.col}>
                        ...
                        <div className={cls.contacts}>
                            <a href="tel:+79000000000" className={cls.phone}>+7 (900) 000-00-00</a>
                            <div className={cls.addr}>г. Москва, ул. Мира, д. 000</div>
                        </div>
                    </div>
                    ...
                    <div className={cls.colRight}>
                        ...
                        <div className={cls.socials}>
                            <a className={cls.social} href="#" aria-label="WhatsApp">
                            ...
                            <a className={cls.social} href="#" aria-label="Telegram">
