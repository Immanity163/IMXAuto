...
export type CatalogCardCar = {
  id: string;
  country: "china" | "korea" | "japan";
  title: string;
  price: number;
  image: string;
  engine: string; // строка как в твоём слайдере
  power: string;  // например: "150 л.с."
  mileage: string; // "123 000"
  fuel: string;
  year: number;
  slug?: string;
};

export default function CatalogCarCard({ car }: { car: CatalogCardCar }) {
