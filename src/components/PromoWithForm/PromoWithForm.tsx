...
const PromoWithForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const {whatsapp, telegram} = useSiteOptions();
          ...
          <div className={cls.infoCard}>
            ...
            <div className={cls.messengersLine}>
              ...
              <div className={cls.mesBtns}>
                <a className={cls.mesBtn} href={whatsapp} aria-label="WhatsApp">
                ...
                <a className={cls.mesBtn} href={telegram} aria-label="Telegram">
